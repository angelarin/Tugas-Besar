            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        @if ($event->id == $sid)
                        <h4 class="page-title">Edit Event {!!$event->nama!!}</h4>
                        @endif
                        @endforeach
                            ...
                            <form action="editupdate" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group m-b-20">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        placeholder="Enter title" required value="{!!$event->nama!!}">
                                    @endif
                                    @endforeach
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box">
                                            ...
                                            @foreach ($events as $event)
                                            @if ($event->id == $sid)
                                            <textarea class="summernote" name="desc" id="desc" required>
                                                {!!$event->desc!!}
                                                </textarea>
                                            @endif
                                            @endforeach
                                ...
                                <div class="form-group m-b-20">
                                    ...
                                    <input type="text" class="form-control" id="harga" name="harga"
                                        placeholder="Masukkan Harga Kegiatan" required value="{!!$event->harga!!}">
                                    @endif
                                    @endforeach
                                </div>
                                ...
                                <div class="form-group m-b-20">
                                    ...
                                    <img class="card-img-top" style="width: 500px; height: auto;" src="{{ asset('/storage/'.$event->picPath)}}"
                                        alt="nama gambar">
                                    </div>
                                    <br>
